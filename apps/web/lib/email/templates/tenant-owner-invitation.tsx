...
const texts = {
  es: {
    ...
    subtitle: (name: string) => `Has sido designado como Tenant Admin del tenant ${name}`,
    ...
    existingSubtitle: (name: string) => `Se te ha otorgado acceso como Tenant Admin al tenant ${name}`,
    login: "Iniciar sesión",
  },
  en: {
    subject: (name: string) => `Activate your access to ${name} on HeptaCore`,
    heading: "Welcome to HeptaCore",
    subtitle: (name: string) => `You have been designated as Tenant Admin of the ${name} tenant`,
    ...
    existingSubtitle: (name: string) => `You have been granted Tenant Admin access to the ${name} tenant`,
    login: "Log in",
  },
};
