const ERROR_MESSAGES: Record<string, string> = {
  LAST_OWNER: "No puedes cambiar el rol ni eliminar al ultimo OWNER del tenant.",
  ...
  TENANT_PROVISIONING: "El tenant esta en provisionamiento. Solo se permiten invitaciones OWNER y configuracion.",
