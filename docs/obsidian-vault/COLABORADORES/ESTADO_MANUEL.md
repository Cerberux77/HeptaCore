...
project: "HeptaCore"
operator: "Manuel"
last_updated: "2026-09-04T13:53:56.732Z"
...
Zonas: `package.json`, `package-lock.json`, `vendor/oreshnik/**`, `scripts/oreshnik/**`, `.kilo/commands/**`, `.kilo/command/**`, `docs/oreshnik/**`, `docs/operations/oreshnik-command-catalog.json`, `docs/07_handoffs/**`
