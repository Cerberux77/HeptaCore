...
- sprint: `email-infra`
- scope: Transactional email deterministic readiness software foundation
...
- zones: `packages/core/src/email-readiness.ts`, `packages/core/src/__tests__/email-readiness.test.ts`, `packages/core/src/index.ts`, `apps/web/app/api/email/readiness/route.ts`, `docs/operations/EMAIL_TRANSACTIONAL_READINESS.md`, `apps/web/app/api/webhooks/resend`, `apps/web/lib/email`, `.env.example`
- resources: -
