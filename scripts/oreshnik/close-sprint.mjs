  ...
  const checks = [
    {
      ...
      command: "node",
      args: ["scripts/oreshnik/canonical-check.mjs", "--sprint", sprint, "--operator", operator]
    },
    {
      name: "Zone check",
      command: "node",
      args: ["scripts/oreshnik/zone-check.mjs", "--sprint", sprint, "--operator", operator]
    },
    {
